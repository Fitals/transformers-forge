...
from transformers.testing_utils import Expectations, cleanup, require_torch, set_seed, slow, torch_device
...
class SamHQModelIntegrationTest(unittest.TestCase):
    def setUp(self):
        set_seed(0)  # Ensure reproducibility for random operations in model
