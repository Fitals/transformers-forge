...
setup(
    ...
    version="1.0.9",  # Transformers Forge v1.0.9 - Interactive Model Manager
    ...
    keywords="transformers-forge machine-learning nlp pytorch transformer llm ema fine-tuning training lora qlora",
    license="Apache 2.0 License",
    url="https://github.com/transformers-forge/transformers-forge",
    package_dir={"": "src"},
