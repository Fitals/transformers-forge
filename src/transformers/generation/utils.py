        ...
        if not using_model_generation_config:
            ...
            if use_model_defaults is True or (
                ...
                for key, model_gen_config_value in model_generation_config.__dict__.items():
                    ...
                    # Check if the user explicitly set this attribute (Issue #42762)
                    # If the attribute was explicitly set, we should NOT overwrite it even if it equals the global default
                    explicitly_set_attrs = getattr(generation_config, "_explicitly_set_attrs", frozenset())
                    was_explicitly_set = key in explicitly_set_attrs
                    if (
                        not was_explicitly_set
