...
METADATA_FIELDS = ("_from_model_config", "_commit_hash", "_original_object_hash", "_explicitly_set_attrs", "transformers_version")
...
class GenerationConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        # Track which attributes were explicitly set by the user (for merging logic in generate)
        # This must be done before any kwargs.pop() calls
        self._explicitly_set_attrs = frozenset(kwargs.keys())
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if "_explicitly_set_attrs" in output:
            del output["_explicitly_set_attrs"]
